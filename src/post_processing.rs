...
impl ViewNode for PostProcessNode {
    ...
    fn run(
        ...
        (view_target, _post_process_settings, prepass_textures): QueryItem<Self::ViewQuery>,
        world: &World,
    ) -> Result<(), NodeRunError> {
        ...
        let prepass_bindings = get_bindings(prepass_textures);
        ...
        let pipeline_id = world
            ...
            .queue_render_pipeline(RenderPipelineDescriptor {
                ...
                fragment: Some(FragmentState {
                    shader,
                    shader_defs: vec!["DEPTH_PREPASS".into()],
